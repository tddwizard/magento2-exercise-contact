...
class Edit extends \TddWizard\ExerciseContact\Controller\Adminhtml\Inquiry
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('tddwizard_exercisecontact_inquiry', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('New Inquiry'));
        return $resultPage;
    }
}
